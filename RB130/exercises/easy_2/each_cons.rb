# each_cons (Part 1)
# The Enumerable#each_cons method iterates over the members of a collection taking each sequence of n consecutive elements at a time and passing 
# them to the associated block for processing. It then returns a value of nil.
...
def each_cons(ar)
  ar.each_with_index do |ele, index|
    yield(ele, ar[index + 1]) if ar[index + 1]
  end
